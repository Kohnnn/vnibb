...
Date: 2026-04-17
> **ARCHIVED 2026-09-23 — do not action.** Stale as of 2026-04-17. Its Phases
> 1, 2 and 4-8 shipped; the remaining gaps were re-homed into
> `WIDGET_IMPROVEMENT_ROADMAP.md` and `WIDGET_IMPROVEMENT_PROGRESS.md`.
>
> **One exception with no other owner:** Phase 3 (USD/FX display) is tracked
> nowhere else. If FX work is still wanted, re-home it before deleting this
> file, or accept it as dropped.
>
**Date of last relevance: 2026-04-17.**
