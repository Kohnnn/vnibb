...
- the active copilot path should stay VNIBB database-first, with database-backed market context as the intended research corpus and fallback paths where temporary quota-pressure bridge paths still apply
