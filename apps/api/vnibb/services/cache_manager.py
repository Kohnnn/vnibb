...
class CacheManager:
    ...
    async def get_screener_data(
        ...
        Args:
            ...
            source: Data source filter (VCI, TCBS, DNSE)
        ...
        try:
            ...
            for record in data:
                ...
                values = {
                    ...
                    "operating_margin": record.get("operating_margin") or record.get("operatingMargin"),
                    "revenue_growth": record.get("revenue_growth") or record.get("revenueGrowth"),
                    "earnings_growth": record.get("earnings_growth") or record.get("earningsGrowth"),
                    ...
                    "foreign_ownership": record.get("foreign_ownership") or record.get("foreignOwnership"),
                    "source": source,
                    "created_at": now,
                }
    ...
    async def get_profile_data(
        ...
        try:
            ...
            if is_stale and not allow_stale:
                ...
                return CacheResult(data=None, is_stale=True, cached_at=company.updated_at, hit=False)
    ...
    async def store_profile_data(
        ...
        try:
            ...
            if company:
                ...
                company.business_description = data.get("description") or company.business_description
                company.outstanding_shares = data.get("outstanding_shares") or company.outstanding_shares
    ...
    async def store_listing_data(
        ...
        try:
            ...
            for record in data:
                ...
                if stock:
                    # Update existing record
                    stock.company_name = record.get("company_name") or record.get("organ_name") or stock.company_name
                    stock.short_name = record.get("short_name") or stock.short_name
                    stock.exchange = record.get("exchange") or stock.exchange
                    stock.industry = record.get("industry") or record.get("industry_name") or stock.industry
