...
# Backward compatibility aliases for pipeline TTLs
CACHE_TTL_LISTING = PIPELINE_TTL_LISTING
CACHE_TTL_PROFILE = PIPELINE_TTL_PROFILE
CACHE_TTL_SCREENER = PIPELINE_TTL_SCREENER
CACHE_TTL_PRICE_LATEST = PIPELINE_TTL_PRICE_LATEST
CACHE_TTL_PRICE_RECENT = PIPELINE_TTL_PRICE_RECENT
CACHE_TTL_FINANCIALS = PIPELINE_TTL_FINANCIALS
CACHE_TTL_FOREIGN_TRADING = PIPELINE_TTL_FOREIGN_TRADING
CACHE_TTL_ORDER_FLOW = PIPELINE_TTL_ORDER_FLOW
CACHE_TTL_INTRADAY = PIPELINE_TTL_INTRADAY
CACHE_TTL_ORDERBOOK = PIPELINE_TTL_ORDERBOOK
CACHE_TTL_ORDERBOOK_DAILY = PIPELINE_TTL_ORDERBOOK_DAILY
CACHE_TTL_BLOCK_TRADES = PIPELINE_TTL_BLOCK_TRADES
CACHE_TTL_DERIVATIVES_LATEST = PIPELINE_TTL_DERIVATIVES_LATEST
CACHE_TTL_DERIVATIVES_RECENT = PIPELINE_TTL_DERIVATIVES_RECENT
