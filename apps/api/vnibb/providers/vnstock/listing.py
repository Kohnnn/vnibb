...
class VnstockListingFetcher:
    ...
    async def fetch_all_symbols(
        ...
        try:
            ...
            raise ProviderError(f"Failed to fetch symbol listing: {e}", provider="vnstock") from e
    ...
    async def fetch_symbols_by_exchange(
        ...
        try:
            ...
            raise ProviderError(
                f"Failed to fetch symbols by exchange: {e}", provider="vnstock"
            ) from e
    ...
    async def fetch_symbols_by_group(
        ...
        try:
            ...
            raise ProviderError(
                f"Failed to fetch symbols by group {group}: {e}", provider="vnstock"
            ) from e
    ...
    async def fetch_industries_icb(
        ...
        try:
            ...
            raise ProviderError(f"Failed to fetch industries ICB: {e}", provider="vnstock") from e
