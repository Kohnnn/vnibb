...
const BUILT_IN_SCREENS: SavedScreen[] = [
  ...
  {
    id: 'cheap_profitable',
    name: 'Cheap Profitable',
    quickFilters: [
      { id: 'pe', value: { gt: 0, lte: 12 }, displayValue: '0 < P/E <= 12' },
      { id: 'pb', value: { gt: 0, lte: 2 }, displayValue: '0 < P/B <= 2' },
      { id: 'roe', value: { gte: 12 }, displayValue: 'ROE >= 12%' },
    ],
    columns: ['ticker', 'pass_reason', 'price', 'pe', 'pb', 'roe', 'market_cap'],
    sortField: 'pe',
    sortOrder: 'asc',
    isBuiltIn: true,
  },
  {
    ...
    quickFilters: [
      { id: 'dividend_yield', value: { gte: 3 }, displayValue: 'Yield >= 3%' },
      { id: 'roe', value: { gte: 10 }, displayValue: 'ROE >= 10%' },
      { id: 'debt_to_equity', value: { lte: 1.5 }, displayValue: 'Debt/Eq <= 1.5' },
    ],
    columns: ['ticker', 'pass_reason', 'price', 'dividend_yield', 'roe', 'debt_to_equity', 'pe'],
    sortField: 'dividend_yield',
    sortOrder: 'desc',
    isBuiltIn: true,
  },
  {
    id: 'growth_reasonable_price',
    name: 'Growth Reasonable Price',
    quickFilters: [
      { id: 'revenue_growth', value: { gte: 10 }, displayValue: 'Revenue growth >= 10%' },
      { id: 'earnings_growth', value: { gte: 10 }, displayValue: 'Earnings growth >= 10%' },
      { id: 'pe', value: { gt: 0, lte: 25 }, displayValue: '0 < P/E <= 25' },
    ],
    columns: ['ticker', 'pass_reason', 'price', 'pe', 'revenue_growth', 'earnings_growth', 'roe'],
    sortField: 'earnings_growth',
    sortOrder: 'desc',
    isBuiltIn: true,
  },
  {
    id: 'low_debt_compounder',
    name: 'Low Debt Compounder',
    quickFilters: [
      { id: 'roe', value: { gte: 15 }, displayValue: 'ROE >= 15%' },
      { id: 'debt_to_equity', value: { lte: 1 }, displayValue: 'Debt/Eq <= 1' },
      { id: 'revenue_growth', value: { gte: 5 }, displayValue: 'Revenue growth >= 5%' },
    ],
    columns: ['ticker', 'pass_reason', 'price', 'roe', 'debt_to_equity', 'revenue_growth', 'moat'],
    sortField: 'roe',
    sortOrder: 'desc',
    isBuiltIn: true,
  },
  {
    id: 'fcf_margin_expansion',
    name: 'FCF Margin Expansion',
    quickFilters: [
      { id: 'fcf_positive', value: true, displayValue: 'FCF positive' },
      { id: 'net_margin', value: { gte: 8 }, displayValue: 'Net margin >= 8%' },
      { id: 'revenue_growth', value: { gte: 5 }, displayValue: 'Revenue growth >= 5%' },
    ],
    columns: ['ticker', 'pass_reason', 'price', 'fcf_positive', 'net_margin', 'revenue_growth', 'margin_of_safety'],
    sortField: 'net_margin',
    sortOrder: 'desc',
    isBuiltIn: true,
  },
  {
