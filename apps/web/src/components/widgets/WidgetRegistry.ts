...
export const defaultWidgetLayouts: Record<WidgetType, { w: number; h: number; minW?: number; minH?: number }> = {
    ...
    key_metrics: { w: 7, h: 10, minW: 6, minH: 8 },
    ...
    balance_sheet: { w: 14, h: 16, minW: 10, minH: 12 },
    income_statement: { w: 14, h: 18, minW: 10, minH: 14 },
    cash_flow: { w: 10, h: 16, minW: 8, minH: 12 },
    ...
    volume_profile: { w: 12, h: 10, minW: 8, minH: 8 },
    ...
    drawdown_recovery: { w: 8, h: 9, minW: 6, minH: 7 },
