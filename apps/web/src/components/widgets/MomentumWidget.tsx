    ...
    <div className="h-full flex flex-col">
      <div className="flex items-center justify-between px-1 py-1 mb-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <WidgetMeta updatedAt={data?.data?.last_data_date ?? data?.data?.computed_at ?? dataUpdatedAt} isFetching={isFetching && hasData} note={`${period} · ${(payload?.adjustment_mode || 'adjusted')} history`} align="right" />
        </div>
      </div>
