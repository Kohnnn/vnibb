...
// This file re-exports from the new modular queries directory for backward compatibility
// New code should import directly from @/lib/queries or @/lib/queries/[domain]
...
import { useVnstockSource } from './queries/common';
...
// Re-export everything from the modular queries directory for backward compatibility
export * from './queries/index';
export { queryKeys } from './queries/legacy';
