...
export const WIDGET_LAYOUT_BEHAVIORS: Record<WidgetType, LayoutBehavior> = {
  ...
  world_news_map: { preferredW: 12, preferredH: 9, minW: 8, minH: 6, orientation: 'horizontal', expandPriority: 4 },
  world_news_live_stream: { preferredW: 7, preferredH: 9, minW: 5, minH: 6, orientation: 'vertical', expandPriority: 2 },
  world_news_sources: { preferredW: 8, preferredH: 9, minW: 5, minH: 6, orientation: 'vertical', expandPriority: 2 },
  ...
  investor_event_calendar: { preferredW: 6, preferredH: 8, minW: 4, minH: 6, orientation: 'vertical', expandPriority: 2 },
  ...
  watchlist_limits_monitor: { preferredW: 5, preferredH: 7, minW: 4, minH: 5, orientation: 'vertical', expandPriority: 2 },
  foreign_flow_leaderboard: { preferredW: 6, preferredH: 7, minW: 4, minH: 5, orientation: 'balanced', expandPriority: 2 },
  ...
  alert_activity_inbox: { preferredW: 6, preferredH: 7, minW: 4, minH: 5, orientation: 'vertical', expandPriority: 2 },
  ...
  source_transparent_research_notebook: { preferredW: 6, preferredH: 8, minW: 4, minH: 5, orientation: 'vertical', expandPriority: 2 },
  market_lab: { preferredW: 6, preferredH: 7, minW: 4, minH: 5, orientation: 'balanced', expandPriority: 2 },
  valuation_lab: { preferredW: 5, preferredH: 8, minW: 4, minH: 6, orientation: 'vertical', expandPriority: 2 },
  ...
  edge_half_life: { preferredW: 6, preferredH: 7, minW: 4, minH: 5, orientation: 'balanced', expandPriority: 2 },
  pair_lab: { preferredW: 6, preferredH: 8, minW: 4, minH: 5, orientation: 'balanced', expandPriority: 2 },
  monte_carlo_lab: { preferredW: 5, preferredH: 7, minW: 4, minH: 5, orientation: 'vertical', expandPriority: 2 },
  backtest_lab: { preferredW: 6, preferredH: 8, minW: 4, minH: 6, orientation: 'vertical', expandPriority: 2 },
  sweep_matrix: { preferredW: 7, preferredH: 8, minW: 5, minH: 6, orientation: 'balanced', expandPriority: 2 },
