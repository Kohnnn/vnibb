...
const WIDGET_LAYOUT_BEHAVIORS: Partial<Record<WidgetType, LayoutBehavior>> = {
  ...
  volume_profile: { preferredW: 8, preferredH: 10, minW: 6, minH: 8, orientation: 'vertical', expandPriority: 2 },
  ...
  correlation_matrix: { preferredW: 11, preferredH: 10, minW: 9, minH: 8, orientation: 'vertical', expandPriority: 2 },
