...
const WIDGET_LAYOUT_BEHAVIORS: Partial<Record<WidgetType, LayoutBehavior>> = {
  ...
  technical_summary: { preferredW: 8, preferredH: 9, minW: 6, minH: 7, orientation: 'balanced', expandPriority: 2 },
  ...
  macd_crossovers: { preferredW: 8, preferredH: 9, minW: 6, minH: 7, orientation: 'balanced', expandPriority: 2 },
  rsi_seasonal: { preferredW: 8, preferredH: 9, minW: 6, minH: 7, orientation: 'balanced', expandPriority: 2 },
  bollinger_squeeze: { preferredW: 8, preferredH: 9, minW: 6, minH: 7, orientation: 'balanced', expandPriority: 2 },
