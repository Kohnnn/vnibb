...
const WIDGET_LAYOUT_BEHAVIORS: Partial<Record<WidgetType, LayoutBehavior>> = {
  ...
  key_metrics: { preferredW: 8, preferredH: 11, minW: 5, minH: 6, orientation: 'vertical', expandPriority: 1 },
  share_statistics: { preferredW: 6, preferredH: 5, minW: 4, minH: 4, orientation: 'vertical', expandPriority: 1 },
  ...
  major_shareholders: { preferredW: 10, preferredH: 6, minW: 5, minH: 4, orientation: 'vertical', expandPriority: 1 },
  insider_trading: { preferredW: 10, preferredH: 6, minW: 5, minH: 4, orientation: 'vertical', expandPriority: 1 },
  officers_management: { preferredW: 12, preferredH: 8, minW: 5, minH: 4, orientation: 'vertical', expandPriority: 2 },
  ...
  transaction_flow: { preferredW: 12, preferredH: 8, minW: 6, minH: 4, orientation: 'horizontal', expandPriority: 4 },
  foreign_trading: { preferredW: 8, preferredH: 8, minW: 5, minH: 5, orientation: 'vertical', expandPriority: 1 },
  orderbook: { preferredW: 8, preferredH: 8, minW: 5, minH: 5, orientation: 'vertical', expandPriority: 1 },
  ...
  top_movers: { preferredW: 8, preferredH: 9, minW: 5, minH: 6, orientation: 'vertical', expandPriority: 1 },
  market_breadth: { preferredW: 8, preferredH: 7, minW: 5, minH: 5, orientation: 'balanced', expandPriority: 2 },
  ...
  quant_summary: { preferredW: 24, preferredH: 10, minW: 10, minH: 8, orientation: 'horizontal', expandPriority: 4 },
