...
const WIDGET_LAYOUT_BEHAVIORS: Partial<Record<WidgetType, LayoutBehavior>> = {
  ...
  ticker_info: { preferredW: 9, preferredH: 8, minW: 7, minH: 6, maxW: 10, orientation: 'balanced', expandPriority: 2 },
  valuation_band: { preferredW: 14, preferredH: 8, minW: 10, minH: 6, orientation: 'horizontal', expandPriority: 4 },
  key_metrics: { preferredW: 7, preferredH: 10, minW: 6, minH: 8, maxW: 10, orientation: 'vertical', expandPriority: 1 },
  ...
  financial_ratios: { preferredW: 10, preferredH: 18, minW: 8, minH: 14, orientation: 'horizontal', expandPriority: 4 },
  income_statement: { preferredW: 14, preferredH: 18, minW: 10, minH: 14, orientation: 'horizontal', expandPriority: 4 },
  income_sankey: { preferredW: 14, preferredH: 10, minW: 10, minH: 7, orientation: 'horizontal', expandPriority: 4 },
  balance_sheet: { preferredW: 14, preferredH: 16, minW: 10, minH: 12, orientation: 'horizontal', expandPriority: 4 },
  cash_flow: { preferredW: 10, preferredH: 16, minW: 8, minH: 12, orientation: 'horizontal', expandPriority: 4 },
  ...
  seasonality_heatmap: { preferredW: 14, preferredH: 9, minW: 10, minH: 7, orientation: 'horizontal', expandPriority: 5 },
  sortino_monthly: { preferredW: 10, preferredH: 8, minW: 8, minH: 6, orientation: 'vertical', expandPriority: 2 },
  volume_profile: { preferredW: 12, preferredH: 10, minW: 8, minH: 8, orientation: 'vertical', expandPriority: 2 },
  volume_flow: { preferredW: 8, preferredH: 10, minW: 6, minH: 8, orientation: 'balanced', expandPriority: 2 },
  momentum: { preferredW: 8, preferredH: 10, minW: 6, minH: 8, orientation: 'balanced', expandPriority: 2 },
  drawdown_recovery: { preferredW: 8, preferredH: 9, minW: 6, minH: 7, orientation: 'balanced', expandPriority: 2 },
  gap_analysis: { preferredW: 8, preferredH: 9, minW: 6, minH: 7, orientation: 'balanced', expandPriority: 2 },
  correlation_matrix: { preferredW: 8, preferredH: 11, minW: 7, minH: 8, orientation: 'vertical', expandPriority: 2 },
  ...
  macd_crossovers: { preferredW: 8, preferredH: 10, minW: 6, minH: 8, orientation: 'balanced', expandPriority: 2 },
  rsi_seasonal: { preferredW: 8, preferredH: 10, minW: 6, minH: 8, orientation: 'balanced', expandPriority: 2 },
  bollinger_squeeze: { preferredW: 8, preferredH: 10, minW: 6, minH: 8, orientation: 'balanced', expandPriority: 2 },
