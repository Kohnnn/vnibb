...
const OWNERSHIP_TEMPLATE: TemplateWidget[] = [
    ...
    },
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 8, w: 8, h: 8, minW: 6, minH: 6 }
    },
    {
        type: 'foreign_trading',
        syncGroupId: 1,
        config: {},
        layout: { x: 8, y: 8, w: 8, h: 8, minW: 6, minH: 6 }
    },
    {
        type: 'insider_trading',
        syncGroupId: 1,
        config: {},
        layout: { x: 16, y: 8, w: 8, h: 8, minW: 6, minH: 6 }
    }
];
...
const CALENDAR_TEMPLATE: TemplateWidget[] = [
    ...
    {
        // TradingView's live Economic Calendar (the legacy native economic_calendar
        // widget was retired; saved dashboards alias to this one).
...
const MAIN_DEEP_DIVE_TEMPLATE: TemplateWidget[] = [
    ...
    },
    {
        ...
        syncGroupId: 1,
        config: { timeframe: '1Y', chartType: 'candle' },
        layout: { x: 8, y: 0, w: 16, h: 10, minW: 10, minH: 8 }
    },
    {
        type: 'ticker_info',
        syncGroupId: 1,
    ...
    },
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 16, y: 10, w: 8, h: 6, minW: 6, minH: 5 }
    },
    {
        type: 'unified_financials',
        syncGroupId: 1,
        config: {},
        layout: { x: 8, y: 16, w: 16, h: 14, minW: 12, minH: 10 }
    },
];
...
const MAIN_QUANT_TEMPLATE: TemplateWidget[] = [
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 0, w: 12, h: 11, minW: 8, minH: 8 }
    },
    {
        type: 'volume_profile',
        syncGroupId: 1,
        config: {},
        layout: { x: 12, y: 0, w: 12, h: 11, minW: 8, minH: 8 }
    },
    {
        type: 'momentum',
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 11, w: 8, h: 11, minW: 6, minH: 8 }
    },
    {
        type: 'drawdown_recovery',
        syncGroupId: 1,
        config: {},
        layout: { x: 8, y: 11, w: 8, h: 11, minW: 6, minH: 8 }
    },
    {
        type: 'signal_summary',
        syncGroupId: 1,
        config: {},
        layout: { x: 16, y: 11, w: 8, h: 11, minW: 6, minH: 8 }
    },
    {
        type: 'gap_analysis',
        syncGroupId: 1,
...
const QUANT_COMPARISON_TEMPLATE: TemplateWidget[] = [
    ...
    },
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 14, y: 0, w: 10, h: 12, minW: 8, minH: 9 }
    },
    {
        type: 'relative_rotation',
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 12, w: 12, h: 10, minW: 8, minH: 8 }
    },
    {
        type: 'rs_ranking',
        syncGroupId: 1,
        config: {},
        layout: { x: 12, y: 12, w: 12, h: 10, minW: 8, minH: 8 }
    },
];
...
const QUANT_MARKET_TEMPLATE: TemplateWidget[] = [
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 0, w: 8, h: 10, minW: 6, minH: 7 }
    },
    {
        type: 'market_breadth',
        syncGroupId: 1,
        config: {},
        layout: { x: 8, y: 0, w: 8, h: 10, minW: 6, minH: 7 }
    },
    {
        type: 'top_movers',
        syncGroupId: 1,
        config: {},
        layout: { x: 16, y: 0, w: 8, h: 10, minW: 6, minH: 7 }
    },
    {
        type: 'money_flow_trend',
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 10, w: 14, h: 12, minW: 10, minH: 9 }
    },
    {
        type: 'industry_bubble',
        syncGroupId: 1,
        config: {},
        layout: { x: 14, y: 10, w: 10, h: 12, minW: 8, minH: 9 }
    },
    {
        type: 'signal_summary',
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 22, w: 24, h: 8, minW: 12, minH: 6 }
    },
];
...
const MAIN_TECHNICAL_TEMPLATE: TemplateWidget[] = [
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 0, w: 12, h: 14, minW: 10, minH: 10 }
    },
    {
        type: 'fibonacci',
        syncGroupId: 1,
        config: {},
        layout: { x: 12, y: 0, w: 12, h: 12, minW: 10, minH: 9 }
    },
    {
        type: 'technical_summary',
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 14, w: 8, h: 10, minW: 6, minH: 8 }
    },
    {
        type: 'technical_snapshot',
        syncGroupId: 1,
        config: {},
        layout: { x: 8, y: 14, w: 8, h: 9, minW: 6, minH: 7 }
    },
    {
        type: 'atr_regime',
        syncGroupId: 1,
        config: {},
        layout: { x: 16, y: 12, w: 8, h: 12, minW: 6, minH: 8 }
    },
    {
        type: 'macd_crossovers',
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 24, w: 8, h: 12, minW: 6, minH: 9 }
    },
    {
        type: 'bollinger_squeeze',
        syncGroupId: 1,
...
const MAIN_TRADING_TEMPLATE: TemplateWidget[] = [
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 0, w: 12, h: 10, minW: 8, minH: 6 }
    },
    {
        type: 'orderbook',
        syncGroupId: 1,
        config: {},
        layout: { x: 12, y: 0, w: 12, h: 10, minW: 8, minH: 6 }
    },
    {
    ...
    },
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 12, y: 10, w: 12, h: 8, minW: 8, minH: 6 }
    },
];
...
const MAIN_MARKET_TEMPLATE: TemplateWidget[] = [
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 0, w: 8, h: 10, minW: 6, minH: 6 }
    },
    {
        type: 'top_movers',
        syncGroupId: 1,
    ...
    },
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 10, w: 12, h: 16, minW: 10, minH: 12 }
    },
    {
        type: 'sector_board',
        syncGroupId: 1,
        config: {},
        layout: { x: 12, y: 10, w: 12, h: 16, minW: 10, minH: 12 }
    },
    {
        type: 'money_flow_trend',
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 26, w: 12, h: 12, minW: 10, minH: 9 }
    },
    {
        type: 'industry_bubble',
        syncGroupId: 1,
        config: {},
        layout: { x: 12, y: 26, w: 12, h: 12, minW: 8, minH: 9 }
    },
];
...
const MAIN_COMPARISON_TEMPLATE: TemplateWidget[] = [
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 0, w: 6, h: 8, minW: 5, minH: 6 }
    },
    {
        type: 'peer_comparison',
        syncGroupId: 1,
        config: {},
        layout: { x: 6, y: 0, w: 18, h: 10, minW: 10, minH: 8 }
    },
    {
        type: 'correlation_matrix',
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 10, w: 12, h: 10, minW: 8, minH: 8 }
    },
    {
        type: 'industry_bubble',
        syncGroupId: 1,
    ...
    },
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 20, w: 24, h: 10, minW: 12, minH: 8 }
    },
];
...
const MAIN_FUNDAMENTALS_TEMPLATE: TemplateWidget[] = [
    {
        ...
        layout: { x: 0, y: 0, w: 12, h: 10, minW: 8, minH: 8 }
    },
    {
        type: 'income_statement',
        syncGroupId: 1,
        config: { periodSyncGroup: 'fundamental-core', hidePeriodToggle: true },
        layout: { x: 12, y: 0, w: 12, h: 10, minW: 8, minH: 8 }
    },
    {
        type: 'balance_sheet',
        syncGroupId: 1,
...
const INITIAL_TECHNICAL_TEMPLATE: TemplateWidget[] = [
    ...
    },
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 10, w: 24, h: 8, minW: 12, minH: 6 }
    },
    {
        type: 'volume_analysis',
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 18, w: 8, h: 6, minW: 6, minH: 5 }
    },
    {
        type: 'momentum',
        syncGroupId: 1,
...
const INITIAL_QUANT_TEMPLATE: TemplateWidget[] = [
    ...
    },
    {
        ...
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 10, w: 14, h: 13, minW: 10, minH: 10 }
    },
    {
        type: 'sortino_monthly',
        syncGroupId: 1,
        config: {},
        layout: { x: 14, y: 10, w: 10, h: 13, minW: 8, minH: 10 }
    },
    {
        type: 'drawdown_recovery',
        syncGroupId: 1,
        config: {},
        layout: { x: 0, y: 23, w: 8, h: 10, minW: 6, minH: 8 }
    },
    {
        type: 'gap_analysis',
        syncGroupId: 1,
        config: {},
        layout: { x: 8, y: 23, w: 8, h: 10, minW: 6, minH: 8 }
    },
    {
        type: 'correlation_matrix',
        syncGroupId: 1,
...
const refreshSystemDashboardTemplates = (dashboards: Dashboard[]): Dashboard[] => {
    const replacementDashboards = new Map<string, Dashboard>([
        [MAIN_DASHBOARD_ID, createMainSystemDashboard()],
        [TECHNICAL_DASHBOARD_ID, createTechnicalSystemDashboard()],
        [QUANT_DASHBOARD_ID, createQuantSystemDashboard()],
        [GLOBAL_MARKETS_DASHBOARD_ID, createGlobalMarketsDashboard()],
    ]);

    return dashboards.map((dashboard) => {
        const replacement = replacementDashboards.get(dashboard.id);
        if (!replacement) {
            return dashboard;
        }
        ...
        return {
            ...
            syncGroups: dashboard.syncGroups.length > 0 ? dashboard.syncGroups : replacement.syncGroups,
            updatedAt: new Date().toISOString(),
        };
    });
};
